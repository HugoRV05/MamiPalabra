...
const icons: Record<IconName, (size: number) => React.ReactElement> = {
  ...
  flame: (size) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 23c-3.9 0-7-3.1-7-7 0-2.1.5-3.4 1.7-5.2.5-.7 1.1-1.5 1.7-2.5.9-1.4 1.5-3 1.8-4.7.1-.4.4-.6.8-.6s.7.2.8.6c.3 1.7.9 3.3 1.8 4.7.6 1 1.2 1.8 1.7 2.5C17.5 12.6 18 13.9 18 16c0 3.9-3.1 7-7 7z" />
    </svg>
  ),
  star: (size) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
  ...
  hard: (size) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3 3 .72 5.75 3.13 5.75 7.5a4.75 4.75 0 0 1-9.5 0c0-1.2.32-2.3.88-3.24C7 14.4 8 16 8 18" />
    </svg>
  ),
